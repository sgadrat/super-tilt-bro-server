...
"$base/extract_mem_labels.py" "$C_LABELS_PATH" "$MEM_LABELS_PATH" "$RAINBOW_LABELS_PATH" > "$CPP_MEM_LABELS_PATH"
echo "uint16_t const fixed_bank_index = $FIXED_BANK_INDEX;" >> "$CPP_MEM_LABELS_PATH"
